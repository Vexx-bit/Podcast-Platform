    ...
    <div class="container">
        ...
        <section class="filters-section">
            ...
            <div class="filters">
                ...
                <a href="favorite_episodes.php" class="filter-btn active" style="text-decoration: none;">Favorites</a>
            </div>
        </section>

        <!-- Episodes Section -->
        <?php
        display_favorite_episodes(); // Call the function to display episodes
        ?>
    </div>
